// src/main/java/com/example/demo/dto/SellRequestViewDTO.java
package com.example.demo.dto;
public class SellRequestViewDTO {
    private String id;
    ...
    private double creditedAmount; // 0 until collected
    private Double collectedKg;    // null until collected
