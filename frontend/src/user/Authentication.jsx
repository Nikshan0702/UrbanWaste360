...
const Authentication = () => {
  ...
  const handleRegister = async () => {
    ...
    // Match exact field names from your User model
    const userData = {
      name: formData.name,
      ...
      email: formData.email,
      password: formData.password
      // role, createdAt, updatedAt handled by backend
    };
  ...
  // Demo login for testing (unchanged)
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          maxLength="50"
                        />
                        <div className="absolute inset-y-0 right-0 flex items μαζί pr-3">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <div className="absolute inset-y-0 right-0 flex items-center pr-3">
                          <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21ல-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502ல4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                          </svg>
                        </div>
                      </div>
                    </div>
